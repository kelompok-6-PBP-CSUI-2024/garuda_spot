...
from .views import (
    ...
    add_news_entry_ajax, delete_news_ajax, api_news, add_news_mobile, delete_news_mobile
)
...
urlpatterns = [
    ...
    path("api/news/delete/<uuid:id>/", delete_news_mobile, name="delete_news_mobile"),
]
